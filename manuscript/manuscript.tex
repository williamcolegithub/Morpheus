...
contrasts hit the n=5 Wilcoxon floor of p = 0.0625; combining them as
binary signs gives a joint probability of $(1/2)^3 = 1/8$ under a no-effect
null (sign-test). Performance against the bag-of-genes baseline was
similarly stable across scales: V1 $-$ bag-of-genes $\Delta$ = +0.22 {[}+0.13, +0.29{]}, V2-104M $-$ bag $\Delta$ = +0.21 {[}+0.14, +0.27{]}, and V2-316M $-$ bag $\Delta$ = +0.20 {[}+0.13, +0.29{]} (each at p = 0.0625, the n = 5 floor). Combining all six matched contrasts (three trained-vs-random plus three trained-vs-bag) as binary signs of the trained-minus-control difference gives a joint $(1/2)^6 = 1/64$ under H$_0$ (one-sided sign-test p $\approx$ 0.016). Critically, scaling the corpus
