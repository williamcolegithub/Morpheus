...
- **L2 TF→target** (PROBE-14). Per-TF binary on gene embeddings, TFs with ≥30 in-vocab targets (375 of 1,199). Negatives: expression-matched (10 quantile bins on log-mean expression in `cells.h5ad`). 80/20 gene split per TF; AUC.
